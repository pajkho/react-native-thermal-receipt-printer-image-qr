    ...
    printRaw: function (text) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                ...
                RNUSBPrinter.printRawData(text, function (error) { return reject(error); }, // This function will be called when an error occurs
                function () { return resolve(); } // This function will be called when the print operation is successful
                );
            }
        });
    },
    ...
    printRaw: function (text) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                ...
                RNBLEPrinter.printRawData(text, function (error) { return reject(error); }, // This function will be called when an error occurs
                function () { return resolve(); } // This function will be called when the print operation is successful
                );
            }
        });
    ...
    printRaw: function (text) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                ...
                RNNetPrinter.printRawData(text, function (error) { return reject(error); }, // This function will be called when an error occurs
                function () { return resolve(); } // This function will be called when the print operation is successful
                );
            }
        });
